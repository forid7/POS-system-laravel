...
<head>
    ...
    <script src="https://use.fontawesome.com/d5c1586c09.js"></script>
...
<body>
                                ...
                                <li class="dropdown hidden-xs">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="md md-settings-power"></i> Logout</a>
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                <div class="user-details">
                    <div class="pull-left">
                        <img src="{{URL::to('public/admin/images/avatar-1.jpg')}}" alt="" class="thumb-md img-circle">
                    </div>
                    <div class="user-info">
                        <div class="dropdown">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="#" class="waves-effect"><i class="fa fa-user"></i><span> Employees </span><span class="pull-right"><i class="md md-add"></i></span></a>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{route('add.advancedsalary')}}">Add Advance Salary</a></li>
                    ...
                    <li class="has_sub">
                        ...
                        <li><a href="#">Monthly Attendances</a></li>
    ...
    <main class="py-4">
        ...
        <script src="{{('public/admin/assets/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
        ...
        <!-- sweet alerts -->
        <script src="{{('public/admin/assets/sweet-alert/sweet-alert.min.js')}}"></script>
        <script src="{{('public/admin/assets/sweet-alert/sweet-alert.init.js')}}"></script>
        ...
        <!-- Dashboard -->
        <script src="{{('public/admin/js/jquery.dashboard.js')}}"></script>

        <!-- Chat -->
        <script src="{{('public/admin/js/jquery.chat.js')}}"></script>

        <!-- Todo -->
        <script src="{{('public/admin/js/jquery.todo.js')}}"></script>
