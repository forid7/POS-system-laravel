				...
				<div class="col-lg-6">
						{{-- <div class="panel">
							<h4 class="text-info">Customer
								<a href="#" class="btn btn-sm btn-primary waves-effect waves-light pull-right" data-toggle="modal" data-target="#con-close-modal">Add A New Customer</a>
							</h4>
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<th>{{$prod->name}}</th>
											<th>
												<form action="{{url('/cart-update/'.$prod->rowId)}}">
													@csrf
													<input type="number" name="qty" value="{{$prod->qty}}" style="width: 30px;">
													<button type="submit" class="btn btn-success" style="margin-top: -2px;"><i class="fa fa-check"></i>
													</button>
												</form> 
											</th>
											<th>{{$prod->price}}</th>
											<th>{{$prod->price*$prod->qty}}</th>
											<th><a href="{{URL::to('/cart-remove/'.$prod->rowId)}}" class="text-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></th>
										</tr>
										@endforeach
									</tbody>
								</table>
						...
						<table id="datatable" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<form action="{{url('/add-cart')}}" method="">
										@csrf
										...
										<td>
											{{-- <a href="#" style="font-size: 20px;"><i class="fa fa-plus-square" aria-hidden="true"></i></a> --}}
										...
										<td><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i></button></td>
									</form>
								</tr>
								@endforeach
							</tbody>
			...
			<div class="modal-dialog"> 
				<div class="modal-content"> 
					<div class="modal-header "> 
						...
						<h4 class="modal-title">Insert New Customer Info</h4> 
					</div> 
