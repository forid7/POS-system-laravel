              ...
              <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Update Attendance  <a href="{{route('all.attendance')}}" class="btn btn-sm btn-info pull-right">All Attendance</a></h3>
                    </div>
      ...
      <tr>
        ...
        <td>
           ...
           if ($row->attendance=='Present') {
            ...
            ?>>Present
            <input type="radio" name="attendance[{{$row->id}}]" value="Absence" <?php
