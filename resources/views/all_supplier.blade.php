                    ...
                    <div class="container">
                          ...
                          <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                      <h3 class="panel-title">All Supplierss</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->phone}}</td>
                                <td>{{$row->address}}</td>
                                <td><img src="{{$row->image}}" style="height: 60px; width: 60px;"></td>
                                <td>{{$row->city}}</td>
                                <td>
                                	...
                                	<a href="{{URL::to('view-supplier/'.$row->id)}}" class="btn btn-sm btn-primary" id="delete">View</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
